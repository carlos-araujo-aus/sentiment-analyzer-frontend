    ...
    import type { PayloadAction } from '@reduxjs/toolkit'; // Import type separately
    ...
    export const { analysisStarted, analysisReceived, analysisFailed } = analysisSlice.actions;

    // A "thunk" that simulates an async API call
    export const simulateFetchAnalysis = (): any => (dispatch: any) => {
